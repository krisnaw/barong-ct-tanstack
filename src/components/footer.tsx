      ...
      <div className="flex flex-col gap-8 px-5 py-10 sm:px-8 lg:flex-row lg:items-end lg:justify-between lg:px-12 lg:py-12">
        <div>
          <p className="flex items-center gap-2.5">
            <span className="grid size-7 place-items-center rounded-md bg-primary font-heading text-xs font-semibold text-primary-foreground">
              B
            </span>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between sm:gap-10">
          <nav aria-label="Footer" className="flex gap-6 text-sm text-white/70">
            <Link
              className="rounded-sm outline-none transition-colors hover:text-white focus-visible:ring-3 focus-visible:ring-primary/70"
              hash="rides"
              to="/"
            >
              Rides
